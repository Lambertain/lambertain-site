...
function systemPrompt(ctx: IntakeCtx, skills: { slug: string; title: string; triggers: string }[], conventions: string): string {
  ...
  return (
    ...
    "5а) Если при изучении кода нашёл баги, уязвимости или дыры — ОБЯЗАТЕЛЬНО включи их в описание задачи отдельным блоком «Попутно исправить» (что не так, где, как чинить). Не игнорируй — иначе копится тех долг.\n" +
