...
export const DICT: Record<string, Entry> = {
  ...
  "comment.mode.internal": { uk: "Внутрішній (команда)", ru: "Внутренний (команда)", en: "Internal (team)" },
  "comment.mode.client": { uk: "Клієнту", ru: "Клиенту", en: "To client" },
  "comment.mode.clientNoDev": { uk: "Клієнту, без розробника", ru: "Клиенту, без разработчика", en: "To client, hide from dev" },
