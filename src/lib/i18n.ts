...
export const DICT: Record<string, Entry> = {
  ...
  "nav.crew": { uk: "Команда", ru: "Команда", en: "Team" },
  ...
  "delegate.status.title": { uk: "Делеговано співробітнику", ru: "Делегировано сотруднику", en: "Delegated to a team member" },
  "delegate.status.to": { uk: "Кому: {name}", ru: "Кому: {name}", en: "To: {name}" },
  "delegate.status.at": { uk: "Делеговано: {date}", ru: "Делегировано: {date}", en: "Delegated: {date}" },
  "delegate.status.seen": { uk: "Прочитано співробітником: {date}", ru: "Прочитано сотрудником: {date}", en: "Read by the team member: {date}" },
  "delegate.status.notSeen": { uk: "Співробітник ще не відкрив задачу", ru: "Сотрудник ещё не открыл задачу", en: "The team member hasn't opened the task yet" },
  "delegate.status.done": { uk: "Виконано: {date}", ru: "Выполнено: {date}", en: "Completed: {date}" },
  "delegate.status.inWork": { uk: "У роботі", ru: "В работе", en: "In progress" },
  ...
  // — «Команда» у клієнта: сам запрошує співробітників у свій проєкт —
  "crew.kicker": { uk: "Ваш проєкт", ru: "Ваш проект", en: "Your project" },
  "crew.title": { uk: "Команда", ru: "Команда", en: "Team" },
  "crew.hint": {
    uk: "Запросіть співробітників у проєкт — вони отримають доступ до задач і зможуть з вами працювати. Створіть посилання й надішліть його людині: відкривши в Telegram, вона приєднається.",
    ru: "Пригласите сотрудников в проект — они получат доступ к задачам и смогут работать с вами. Создайте ссылку и отправьте её человеку: открыв в Telegram, он присоединится.",
    en: "Invite your employees to the project — they get access to tasks and can work with you. Create a link and send it to the person: opening it in Telegram joins them.",
  },
  "crew.inviteTitle": { uk: "Запросити співробітника", ru: "Пригласить сотрудника", en: "Invite an employee" },
  "crew.membersTitle": { uk: "Ваші співробітники", ru: "Ваши сотрудники", en: "Your employees" },
  "crew.empty": { uk: "Ви ще нікого не запросили.", ru: "Вы ещё никого не пригласили.", en: "You haven't invited anyone yet." },
  "crew.remove": { uk: "Прибрати з команди", ru: "Убрать из команды", en: "Remove from team" },
  "crew.removeConfirm": { uk: "Прибрати співробітника? Він втратить доступ до проєкту (історія задач збережеться).", ru: "Убрать сотрудника? Он потеряет доступ к проекту (история задач сохранится).", en: "Remove the employee? They lose access to the project (task history is kept)." },
  "crew.removeYes": { uk: "Так, прибрати", ru: "Да, убрать", en: "Yes, remove" },
  "crew.noProject": { uk: "Проєкт не визначено — зверніться до Lambertain.", ru: "Проект не определён — обратитесь в Lambertain.", en: "No project resolved — contact Lambertain." },
