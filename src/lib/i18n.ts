...
export const DICT: Record<string, Entry> = {
  ...
  "projects.autoMigrateHint": { uk: "Клієнтський деплой сам застосовує схему (preDeploy). Попередження про схему при доставці не блокує.", ru: "Клиентский деплой сам применяет схему (preDeploy). Предупреждение о схеме при доставке не блокирует.", en: "The client deploy applies the schema itself (preDeploy). The schema warning won't block delivery." },
