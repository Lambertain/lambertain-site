...
const POLLER_ERROR_TITLE_PATTERNS = [
  ...
  "%GitHub API тимчасово%",  // агрегированное уведомление о транзитной деградации GitHub
  "%Авто-доставка — деплой не вдався%", // алерт деплоя авто-доставки (в т.ч. ложный «НЕ той коміт» при гонке доставок)
];
