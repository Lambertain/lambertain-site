 ...
 * Зеркалирование идемпотентно (DEV-51): каждый GitHub-элемент — один раз (mirrored_pr_items, ключ gh_id),
 * условные запросы (ETag) экономят квоту. Ошибки синка НЕ пишем в тред задачи — только админу (throttled)/в лог.
